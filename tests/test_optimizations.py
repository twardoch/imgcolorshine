...
"""
Test script for hierarchical and spatial acceleration optimizations.
"""
...
from imgcolorshine import OKLCHEngine, ColorTransformer, ImageProcessor
...
def test_hierarchical_processing():
    """Test hierarchical processing optimization."""
    logger.info("Testing hierarchical processing...")
...
def test_combined_optimizations():
    """Test combined hierarchical + spatial acceleration."""
    ...
    result = process_with_optimizations(
        ...
        hierarchical=True, spatial_accel=True,
        transformer=transformer, engine=engine
    )
    elapsed = time.time() - start_time
