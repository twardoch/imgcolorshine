    ...
    class cuda:
        ...
        class MemoryPool:
            ...
            def free_all_blocks(self):
                pass
            def used_bytes(self): return self.used_bytes_val
            def total_bytes(self): return self.total_bytes_val
            def n_free_blocks(self): return self.n_free_blocks_val
...
def test_check_jax_available_not_installed():
    ...
    original_jax_in_modules = 'jax' in sys.modules
    original_jax_numpy_in_modules = 'jax.numpy' in sys.modules

    if 'jax' in sys.modules: del sys.modules['jax']
    if 'jax.numpy' in sys.modules: del sys.modules['jax.numpy']
...
def test_cupy_import_generic_exception():
    ...
    original_gpu_available = gpu_module.GPU_AVAILABLE
...
def test_jax_import_generic_exception():
    ...
    assert gpu_module.GPU_AVAILABLE == original_cupy_gpu_available
