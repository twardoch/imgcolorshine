...
# ///
# this_file: src/imgcolorshine/fast_numba/engine_numba.py

"""Numba-optimized engine components, e.g., fused kernels."""

import numba
import numpy as np

from . import trans_numba # For oklab_to_oklch_single

# Constants (mirrored from engine.py for standalone use if necessary)
